...
export const metadata: Metadata = {
  ...
  description: "Contactez TEKNOPY Concept pour un devis gratuit sous 24h. Téléphone : +596 696 617 151. Email : manuel.harpon@teknopy.com. Fort-de-France, Martinique.",
  keywords: [
